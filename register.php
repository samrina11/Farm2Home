...
<body>
    <div class="register-container">
        <div class="logo">
            ...
            <p>Join our community of fresh food lovers</p>
        </div>
        ...
        <form method="POST" action="">
            ...
            <div class="form-group">
                ...
                <textarea id="address" name="address" placeholder="Enter your complete address"><?php echo htmlspecialchars($_POST['address'] ?? ''); ?></textarea>
            </div>
